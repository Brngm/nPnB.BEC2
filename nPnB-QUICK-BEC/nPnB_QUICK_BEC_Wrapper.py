...
"""
    ...
    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    METRICS:
        _TPTNFPFN_Intrinsic(PathnPnB, GraphString, ClustString)

        _TPTNFPFN_GOLD_C(PathnPnB, GOLDString, ClustString, n_verticesString)

    CLUSTERING WITHOUT OVERLAPS:
        _mmm(PathnPnB, GraphString, ClustZero, Beta, RandNode, Epsilon, Verbose)

    CLUSTERING ALLOWING OVERLAPS:
        _overlaps(PathnPnB, GraphString, ClustZero, Beta, RandNode, Verbose)
"""
import ctypes

# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
def _mmm(PathnPnB, GraphString, ClustZero, Beta, RandNode, Epsilon, Verbose):
    """
    _mmm(PathnPnB, GraphString, ClustZero, Beta, RandNode, Epsilon, Verbose)
    """
    # =====================================================================
    lib_path = PathnPnB + "nPnB-QUICK-BEC_C++/result/bin/libnPnB-QUICK-BEC.so" # Path to the compiled shared library
...
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
def _overlaps(PathnPnB, GraphString, ClustZero, Beta, RandNode, Verbose):
    """
    _Overlaps(PathnPnB, GraphString, ClustZero, Beta, RandNode, Verbose)
    """
    # =====================================================================
...
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
def _TPTNFPFN_Intrinsic(PathnPnB, GraphString, ClustString):
    """
    _TPTNFPFN_Intrinsic(PathnPnB, GraphString, ClustString)
    """
    # =====================================================================
...
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
def _TPTNFPFN_GOLD_C(PathnPnB, GOLDString, ClustString, n_verticesString):
    """
    _TPTNFPFN_GOLD_C(PathnPnB, GOLDString, ClustString, n_verticesString)
    """
    # =====================================================================
