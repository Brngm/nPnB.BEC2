  ...
  CH=CH+"""
    <script>
        ...
        window.addEventListener("load", event => {
            ...
            //===================================================================================================
            function myLabelString(id) { return "(id=" + gData.nodes[id].id + ":label=" + gData.nodes[id].name + ")" }
            ...
            function myNeighborsString(id) {
                ...
                if ((neighbors[1].length) > 0) {
                    UNVneighborsString = "<br>" + VneighborsString
                }

                let Vn = ((neighbors[0].length) <= 1) ? " VISIBLE NEIGHBOR: " : " VISIBLE NEIGHBORS: ";
                let UNVn = ((neighbors[1].length) <= 1) ? " INVISIBLE NEIGHBOR: " : " INVISIBLE NEIGHBORS: ";
